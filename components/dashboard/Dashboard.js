...
const createActivityChart = (walking, running, cycling) => {
    ...
    dates = dates.reverse();
    let walking_data = countActivityPerDates(walking, dates, 7);
    let running_data = countActivityPerDates(running, dates, 7);
    let cycling_data = countActivityPerDates(cycling, dates, 7);
                ...
                <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <div>
                            ...
                            {apiRead && (
                                <span className="block text-2xl font-bold">
                                    {activityData.walking.all.length}
                                </span>
                            )}
                            <span className="block text-gray-500">Walking</span>
                        </div>
                    </div>
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <div>
                            ...
                            {apiRead && (
                                <span className="block text-2xl font-bold">
                                    {activityData.running.all.length}
                                </span>
                            )}
                            <span className="block text-gray-500">Running</span>
                        </div>
                    </div>
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <div>
                            ...
                            <span className="block text-gray-500">Cycling</span>
                        </div>
                    </div>
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <section className="grid md:grid-cols-2 xl:grid-cols-2 gap-6">
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <div>
                            ...
                            {apiRead && (
                                <span className="block text-2xl font-bold">
                                    {activityData.walking.total_calories.toFixed(
                                        2
                                    )}{" "}
                                    kcal ({activityData.walking.total_steps}{" "}
                                    steps)
                                </span>
                            )}
                            <span className="block text-gray-500">Walking</span>
                    ...
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <div>
                            ...
                            {apiRead && (
                                <span className="block text-2xl font-bold">
                                    {activityData.running.total_calories.toFixed(
                                        2
                                    )}{" "}
                                    kcal ({activityData.running.total_steps}{" "}
                                    steps)
                                </span>
                            )}
                            <span className="block text-gray-500">Running</span>
                        ...
                        <div>
                            ...
                            {apiRead && (
                                <span className="inline-block text-2xl font-bold">
                                    ...
                                    kcal ({activityData.cycling.total_steps}{" "}
                                    steps)
                                </span>
                            )}
                            <span className="block text-gray-500">Cycling</span>
                    ...
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <div>
                            ...
                            {apiRead && (
                                <span className="block text-2xl font-bold">
                                    {(
                                        activityData.walking.total_calories +
                                        activityData.running.total_calories +
                                        activityData.cycling.total_calories
                                    ).toFixed(2)}{" "}
                                    kcal (
                                    {activityData.walking.total_steps +
                                        activityData.running.total_steps +
                ...
                <section className="grid md:grid-cols-2 xl:grid-cols-2 gap-6">
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <div>
                            ...
                            {apiRead && (
                                <span className="block text-2xl font-bold">
                                    {activityData.walking.total_distance.toFixed(
                                        2
                                    )}{" "}
                                    m
                                </span>
                    ...
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <div>
                            ...
                            {apiRead && (
                                <span className="block text-2xl font-bold">
                                    {activityData.running.total_distance.toFixed(
                                        2
                                    )}{" "}
                                    m
                                </span>
                    ...
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <div>
                            ...
                            {apiRead && (
                                <span className="block text-2xl font-bold">
                                    {(
                                        activityData.walking.total_distance +
                                        activityData.running.total_distance +
                                        activityData.cycling.total_distance
                                    ).toFixed(2)}{" "}
                                    m
                                </span>
                            )}
